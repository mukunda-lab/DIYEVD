...
export const countries: Country[] = [
  {
    ...
    flag: '🇪🇸',
    accentColor: '#e8697a',
    registrationEmail: 'espana@evdsky.com',
    registrationPhone: '+34 633226562',
    days: [
      {
        date: 'Jueves 18 de junio',
        location: 'Calle Sucre 22, 2º drch. · Las Palmas de Gran Canaria',
        items: [
          { time: '18:00–19:00h', activity: 'Clase de Shanti Shakti Yoga' },
          { time: '19:30–20:30h', activity: 'Meditación guiada por Mataji Shaktiananda' },
        ],
      ...
      },
      {
        ...
        location: 'Calle Sucre 22, 2º drch. · Las Palmas de Gran Canaria',
        items: [{ time: '8:00–9:30h', activity: 'Clase de Atma Shakti Yoga y Meditación' }],
        contact: '+34 633226562',
      },
      {
        date: 'Domingo 21 de junio · Las Palmas',
        location: 'Calle Sucre 22, 2º drch. · Las Palmas de Gran Canaria',
        items: [
          ...
          { time: '11:00–12:30h', activity: 'Charla sobre el Yoga' },
          { time: '12:30–13:00h', activity: 'Meditación' },
        ],
        contact: '+34 633226562',
      },
      {
        date: 'Domingo 21 de junio · Madrid',
  ...
  },
  {
    ...
    flag: '🇨🇴',
    accentColor: '#fbbf24',
    registrationPhone: '+573106307403',
    days: [
      {
        date: 'Domingo 14 de junio',
        location: 'Parque Virgilio Barco · Av. Carrera 60 #57-60 (Punto de ciclovía IDRD) · Bogotá',
        items: [
          { time: '8:00 am', activity: 'Protocolo Común de Yoga' },
          { activity: 'Hatha Yoga — Escuela Valores Divinos' },
          { activity: 'Meditación' },
        ],
        contact: '+573106307403',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    flag: '🇨🇷',
    accentColor: '#f97316',
    registrationEmail: 'costarica@evdsky.com',
    registrationPhone: '+506 8982-9555',
    days: [
      {
        date: 'Viernes 19 de junio',
        location: 'Ashram Caminantes del Atardecer · Uvita, Bahía Ballena (300m Oeste del Maxi Palí)',
        items: [{ time: '6:30–7:30 pm', activity: 'Kirtan y Ceremonia de Fuego Sagrado' }],
        contact: '+506 8982-9555',
      },
      {
        date: 'Sábado 20 de junio',
        location: 'Ashram Caminantes del Atardecer · Uvita, Bahía Ballena',
        items: [
          { time: '9:00–10:20 am', activity: 'Pranayama y Shakti Yoga' },
          { time: '10:20–11:00 am', activity: 'Meditación guiada' },
          { time: '11:00–12:00 pm', activity: 'Charla sobre Yoga' },
        ],
        contact: '+506 8982-9555',
      },
    ],
