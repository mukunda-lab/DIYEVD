...
const CAPS: React.CSSProperties = { fontFamily: '"Cormorant SC", Georgia, serif', fontWeight: 300 }
  ...
  return (
    <section style={{ background: `linear-gradient(160deg, ${BG} 0%, #0b1d48 50%, #0f1560 100%)` }}>
      ...
      <div className="lg:hidden flex flex-col">
        ...
        >
          <p className="text-xs tracking-[0.22em] uppercase" style={{ ...CAPS, color: 'rgba(200,210,240,0.7)' }}>
        ...
        >
          <div className="flex flex-col items-center gap-1 mb-5">
            <p className="text-xs tracking-[0.28em] uppercase" style={{ ...CAPS, color: 'rgba(180,200,240,0.5)' }}>
              Fecha principal
            </p>
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-xs">
            <div
              ...
              style={{ ...CAPS, background: 'rgba(245,197,24,0.1)', border: '1px solid rgba(245,197,24,0.3)', color: '#f5c518' }}
            >
      ...
      <div className="hidden lg:flex lg:flex-col relative overflow-hidden" style={{ minHeight: '100vh' }}>
        ...
        <div className="relative flex items-center justify-between px-8 pt-7" style={{ zIndex: 2, opacity: visible ? 1 : 0, transition: 'opacity 1s ease 0.4s' }}>
          <p className="text-xs tracking-[0.28em] uppercase" style={{ ...CAPS, color: 'rgba(200,210,240,0.75)' }}>
            Escuela Valores Divinos
          </p>
          <p className="text-sm tracking-wider" style={{ ...CAPS, color: 'rgba(200,210,240,0.5)' }}>
            {activities.join(' · ')}
          </p>
        </div>
        ...
        <div className="relative flex flex-col items-center text-center px-4 pb-14" style={{ zIndex: 2, opacity: visible ? 1 : 0, transition: 'opacity 1s ease 0.9s' }}>
          <div className="flex items-center gap-8 mb-6">
            <div className="text-center">
              <p className="text-xs tracking-[0.28em] uppercase mb-1" style={{ ...CAPS, color: 'rgba(180,200,240,0.55)' }}>Fecha principal</p>
            ...
            <div className="text-center">
              <p className="text-xs tracking-[0.28em] uppercase mb-1" style={{ ...CAPS, color: 'rgba(180,200,240,0.55)' }}>Solsticio de verano</p>
          ...
          <div className="flex items-center gap-4">
            <div className="px-4 py-2 rounded-full text-xs tracking-[0.22em] uppercase" style={{ ...CAPS, background: 'rgba(245,197,24,0.1)', border: '1px solid rgba(245,197,24,0.3)', color: '#f5c518' }}>
              Actividad gratuita y abierta
            </div>
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 animate-float" style={{ zIndex: 2, color: 'rgba(180,200,240,0.35)', animationDuration: '3s' }}>
          ...
          <span className="text-xs tracking-widest uppercase" style={CAPS}>Scroll</span>
        </div>
      </div>
    </section>
  )
