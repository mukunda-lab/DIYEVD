...
export default function Hero() {
  ...
  return (
    <section
      style={{ background: `linear-gradient(160deg, ${BG} 0%, #0b1d48 50%, #0f1560 100%)` }}
    >
      {/* ── MOBILE: imagen contenida + contenido debajo ── */}
      <div className="lg:hidden flex flex-col">
        ...
        >
          <p className="text-xs font-light tracking-[0.22em] uppercase" style={{ color: 'rgba(200,210,240,0.7)' }}>
            Escuela Valores Divinos
          </p>
        </div>

        {/* Banner image — contenido al 100% del ancho, altura proporcional */}
        <div
        ...
        >
          ...
          />
          {/* Fade suave solo abajo */}
          <div
            className="absolute bottom-0 left-0 right-0 pointer-events-none"
            style={{
              height: '40%',
              background: `linear-gradient(to top, rgba(${BG_RGB},1) 0%, rgba(${BG_RGB},0.7) 50%, transparent 100%)`,
            }}
          />
        </div>

        {/* Contenido: fecha + pills + CTA */}
        <div
        ...
        >
          <div className="flex flex-col items-center gap-1 mb-5">
            <p className="text-xs tracking-[0.25em] uppercase" style={{ color: 'rgba(180,200,240,0.5)' }}>
              Fecha principal
            </p>
            <p className="text-2xl font-semibold" style={{ color: '#f5c518' }}>
              21 de junio · 2026
            </p>
            <p className="text-sm font-light mt-1" style={{ color: 'rgba(200,215,255,0.7)' }}>
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-xs">
            <div
              className="px-4 py-2 rounded-full text-xs font-medium tracking-[0.18em] uppercase w-full text-center"
              style={{
            ...
            <a
              href="#sedes"
              className="btn-gradient w-full py-3 rounded-full text-sm font-medium text-center"
      ...
      {/* ── DESKTOP: imagen cover + contenido superpuesto ── */}
      <div
      ...
      >
        ...
        >
          ...
          <p className="text-xs font-light tracking-wider" style={{ color: 'rgba(200,210,240,0.5)' }}>
            {activities.join(' · ')}
          </p>
        </div>
        ...
        >
          <div className="flex items-center gap-8 mb-6">
            <div className="text-center">
              <p className="text-xs tracking-[0.25em] uppercase mb-1" style={{ color: 'rgba(180,200,240,0.55)' }}>Fecha principal</p>
              <p className="text-2xl font-light" style={{ color: '#f5c518' }}>21 de junio · 2026</p>
            </div>
            <div className="w-px h-10" style={{ background: 'rgba(124,58,237,0.4)' }} />
            <div className="text-center">
              <p className="text-xs tracking-[0.25em] uppercase mb-1" style={{ color: 'rgba(180,200,240,0.55)' }}>Solsticio de verano</p>
              <p className="text-base font-light" style={{ color: 'rgba(200,215,255,0.8)' }}>Actividades en 8 países</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-7">
            {activities.map((act) => (
              <span
                ...
                style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(210,220,255,0.8)' }}
              >
                {act}
              </span>
            ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#sedes" className="px-6 py-3 rounded-full text-sm font-medium btn-gradient" style={{ letterSpacing: '0.08em' }}>
              Ver actividades por país ↓
            </a>
          </div>
        </div>
